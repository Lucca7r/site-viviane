    ...
    import { client } from '../sanity/client'; // Importa o cliente Sanity
    ...
    const FaqItem = ({ item }) => {
      ...
      return (
        <div className="border-b border-gray-300 py-4">
          ...
          >
            <h3 className="text-lg font-semibold text-cinza-texto">{item.pergunta}</h3>
            <span>
    ...
    const Faq = () => {
      ...
      if (loading) return <div className="text-center py-20">Carregando perguntas...</div>;
